...
public class SettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mValue_currentWeek.setText("第"+ProgramConfig.current_week+"周");
        ...
        mItem_currentWeek.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                value.setHint("输入当前是第几周");
                value.setText("" + ProgramConfig.current_week);
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {
                                    ...
                                    if (val <= 0 || val > 20) {
                                        Toast.makeText(SettingActivity.this, "请输入介于0到20之间的整数。", Toast.LENGTH_SHORT).show();
                                        return;
                                    }
                                    ProgramConfig.current_week = val;
                                    ProgramConfig.json.remove("current_week");
                                    try {
                                        ProgramConfig.json.put("current_week", val);
                                        Static.WriteSettings();
                                    } catch (Exception e) {
                                        e.printStackTrace();
                                    }
                                    mValue_currentWeek.setText("第" + val + "周");
